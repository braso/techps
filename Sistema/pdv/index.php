...
function buscar_venda(){
	...
	<table class="table table-bordered">
		...
		<tr>
			...
			<th width="10%" scope="col">Valor&nbsp;Bruto</th>
			<th width="10%" scope="col">Desconto</th>
			<th width="10%" scope="col">Valor&nbsp;Líquido</th>
...
function buscar_produto(){
	...
	if($_GET['q'] != ''){
		...
		$sql = "SELECT prod_nb_id,prod_tx_nome,prod_tx_codigoBarras,prod_tx_preco,prod_tx_qtde,prod_tx_servico FROM produto 
		...
		while($row = $result->fetch_assoc()){
			...
			if ( trim($row['prod_tx_servico'])!='sim' ) {
				$nome_exibir .= ' =>  QTDE: '.valor($row['prod_tx_qtde'],1);
			}
...
function index(){
	...
	<head>
		...
		<style type="text/css">
			@media screen AND (max-width: 730px){
				...
				body .container-fluid p.text-left{
					position: relative;
					margin: 0;
					padding: 0;
					width: 25%;
				...
				body .container-fluid p.text-right{
					position: relative;
					margin: 0;
					padding: 1.35% 5% 1.35% 0;
					width: 25%;
					float: left;
					/*background-color: red;*/
				}
				body .container-fluid #div_principal{
					position: relative;
					margin: 0;
					padding: 0;
					width: 100%;
				...
				body .container-fluid #div_principal .col-sm-12.col-md-12.modo_mobile1{
					position: relative;
					margin: 0;
					padding: 0;
					width: 100%;
				...
				body .container-fluid #div_principal .col-sm-12.col-md-12.modo_mobile1 .col-sm-10.col-md-10{
					position: relative;
					margin: 0;
					padding: 0 0 0 2.5%;
					width: 50%;
				...
				body .container-fluid #div_principal .col-sm-12.col-md-12.modo_mobile1 .col-sm-2.col-md-2{
					position: relative;
					margin: 0;
					padding: 0 0 0 5%;
					width: 50%;
				...
				body .container-fluid #div_principal .col-sm-3.sidenav{
					position: relative;
					margin: 0;
					padding: 0;
					width: 100%;
				...
				body .container-fluid #div_principal .col-sm-3.sidenav .botoes{
					position: relative;
					margin: 0;
					padding: 0;
					width: 100%;
				...
				body .container-fluid #div_principal .col-sm-3.sidenav .botoes button{
					/*position: relative;*/
					/*margin: 0;*/
					/*padding: 0;*/
					width: 23%;
				...
				body .container-fluid #div_principal .col-sm-9.box_right{
					position: relative;
					margin: 0;
					padding: 0;
					width: 100%;
				...
				body .container-fluid #div_principal .col-sm-9.box_right .panel.panel-default.col-md-12.box_itens{
					position: relative;
					margin: 0;
					padding: 0;
					width: 100%;
				...
				body .container-fluid #div_principal .col-sm-9.box_right .panel.panel-default.col-md-12.modo_mobile2{
					position: relative;
					margin: 0;
					padding: 0;
					width: 100%;
				...
				body .container-fluid #div_principal .col-sm-9.box_right .panel.panel-default.col-md-12.modo_mobile2 form .form-group.col-md-4{
					position: relative;
					margin: 0;
					padding: 1%;
					width: 100%;
				...
				body .container-fluid #div_principal .col-sm-9.box_right .panel.panel-default.col-md-12.modo_mobile2 form .form-group.col-md-4 label{
					position: relative;
					margin: 0;
					padding: 0;
					width: 50%;
				...
				body .container-fluid #div_principal .col-sm-9.box_right .panel.panel-default.col-md-12.modo_mobile2 form .form-group.col-md-4 h1{
					position: relative;
					margin: 0;
					padding: 0;
					width: 50%;
				...
				body .container-fluid #div_principal .col-sm-9.box_right .panel.panel-default.col-md-12.modo_mobile2 form .form-group.col-md-3{
					position: relative;
					margin: 0;
					padding: 1%;
					width: 100%;
				...
				body .container-fluid #div_principal .col-sm-9.box_right .panel.panel-default.col-md-12.modo_mobile2 form .form-group.col-md-3 label{
					position: relative;
					margin: 0;
					padding: 0;
					width: 50%;
				...
				body .container-fluid #div_principal .col-sm-9.box_right .panel.panel-default.col-md-12.modo_mobile2 form .form-group.col-md-3 h1{
					position: relative;
					margin: 0;
					padding: 0;
					width: 50%;
				...
				body .container-fluid #div_principal .col-sm-9.box_right .panel.panel-default.col-md-12.modo_mobile2 form .form-group.col-md-5{
					position: relative;
					margin: 0;
					padding: 1%;
					width: 100%;
				...
				body .container-fluid #div_principal .col-sm-9.box_right .panel.panel-default.col-md-12.modo_mobile2 form .form-group.col-md-5 label{
					position: relative;
					margin: 0;
					padding: 0;
					width: 50%;
				...
				body .container-fluid #div_principal .col-sm-9.box_right .panel.panel-default.col-md-12.modo_mobile2 form .form-group.col-md-5 h1{
					position: relative;
					margin: 0;
					padding: 0;
					width: 50%;
	...
	<div class="container-fluid">
		...
		<div class="col-sm-12 col-md-12 modo_mobile1" style="background-color: #F1F1F1; padding: 1% 0 1% 0;">
		...
		<div class="col-sm-9 box_right">
			...
			<div class="panel panel-default col-md-12 modo_mobile2">
		...
		<div class="modal fade" id="modalPagamento" tabindex="-1" role="dialog" aria-labelledby="ModalPagamentoLabel" aria-hidden="true">
			...
			<div class="modal-content">
				...
				<div class="col-sm-6 margin-bottom-5">
					...
					<script type="text/javascript">
						function mascara_valor_pagamento(z) {	
							v = z.value;
						...
						window.document.getElementById('valor_pagamento').addEventListener('keyup', function() {
							mascara_valor_pagamento(this);
						});
					</script>
				</div>
				<div class="col-sm-6 margin-bottom-5">
		...
		<div class="modal fade" id="modalSenha" tabindex="-1" role="dialog" aria-labelledby="ModalSenhaLabel" aria-hidden="true">
			...
			<div class="modal-content">
				<div class="modal-header">
				<h4 class="modal-title" id="ModalSenhaLabel"><b>SENHA GERENCIAL!</b></h4>
				<button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
					<span aria-hidden="true">&times;</span>
				</button>
				</div>
				<div class="modal-body col-md-12">
					<div class="col-sm-6 margin-bottom-5">
						<label><b>Informe uma senha gerencial:</b></label>
						<input name="cp_senha_gerencial" id="cp_senha_gerencial" value=""  autocomplete="off" type="password" class="form-control input-sm">
					</div>
				</div>
				<!-- ESSE IMPUT SERVE PARA DEVOLVER TODO O CONTEUDO DO POST QUE CHEGOU NO FUNÇÕES PDV -->
				<input type="hidden" name="dados_extras_modal_senha" id="dados_extras_modal_senha">
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
					<button type="button" class="btn btn-primary" id="bt_senha_gerencial">Autorizar</button>
				</div>
			</div>
			</div>
		</div>
		...
		<script type="text/javascript">
			...
			$("#bt_senha_gerencial").click(function() {

				submit_modal_senha();
			});

			$("#cp_senha_gerencial").keydown(function(e){
				var keyCode = e.keyCode || e.which;
				if ( keyCode==13 ) {// SE TECLOU ENTER
					submit_modal_senha();
				}
			});


			function submit_modal_senha(){
				var dados = $('#dados_extras_modal_senha').val();				
				var senha_gerencial = $("#cp_senha_gerencial").val();

				// CONCATENA OS NOVOS DADOS COM OS QUE FORAM RECEBIDOS
				dados += "&senha_gerencial="+senha_gerencial+"&senha_solicitada=sim";
			...
			$('#modalSenha').on('show.bs.modal', function () {
				$('#cp_senha_gerencial').focus();
			});

			$('#modalSenha').on('hide.bs.modal', function () {
				// EVITA QUE O PRODUTO FIQUE SELECIONADO AO FECHAR O MODAL
