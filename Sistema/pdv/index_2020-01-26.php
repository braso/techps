...
function gera_grid_produtos(){
	...
	if ( $id_venda>0 ) {
		...
		if ( $a_venda['orde_tx_valorFrete']>0 ) {
			// CASO TENHA O VALOR DO TAXI DOG/ FRETE
			?><tr>
				<td class="text-center">&nbsp;</td>
				<td class="text-center">&nbsp;</td>
				<td>TÁXI DOG</td>
				<td class="text-center">1,000</td>
				<td class="text-center"><?=valor($a_venda['orde_tx_valorFrete'],1)?></td>
				<td class="text-center">&nbsp;</td>
				<td class="text-center"><?=valor($a_venda['orde_tx_valorFrete'],1)?></td>
				<td class="text-center">&nbsp;</td>
			</tr><?php
		...
		?><script type="text/javascript">
			...
			document.getElementById('valor_taxi_dog').value = "<?=valor($a_venda[orde_tx_valorFrete],1)?>";
		</script><?php
	}
	...
	<head>
		...
		<script type="text/javascript">
			...
			function limpar_venda(){
				if ( confirm('Deseja limpar a Venda?') ) {
	...
	<div class="container-fluid">
		...
		<div class="col-sm-3 sidenav">
			...
			<div class="botoes">
				...
				<button type="button" class="btn btn-default col-md-5" data-toggle="modal" data-target="#modalDesconto"><img src="img/icon001.png" alt="img/icon001.png"/> Desconto (F7)</button>
				<button type="button" class="btn btn-default col-md-5" data-toggle="modal" data-target="#modalTaxiDog"><img src="img/icon001.png" alt="img/icon001.png"/> Táxi Dog (F8)</button>
				<button type="button" class="btn btn-default col-md-5" onclick="limpar_venda();"><img src="img/icon005.png" alt="img/icon005.png"/> Limpar (F9)</button>
				<button type="button" class="btn btn-default col-md-5" onclick="cancelar_venda();"><img src="img/icon005.png" alt="img/icon005.png"/> Cancelar (F10)</button>
			</div>
			</div>
		</div>
