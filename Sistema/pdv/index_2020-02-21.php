	...
	<div class="container-fluid">
		...
		<div class="col-sm-3 sidenav">
			...
			<div class="botoes">
				...
				<button type="button" class="btn btn-default col-md-5" onclick="limpar_venda();"><img src="img/limpar.png" alt="img/limpar.png"/> Limpar (F9)</button>
		...
		<div class="modal fade" id="modalPagamento" tabindex="-1" role="dialog" aria-labelledby="ModalPagamentoLabel" aria-hidden="true">
			...
			<script type="text/javascript">
				...
				function adiciona_pagamento(id_forma){
					...
					if ( id_forma==4 && id_entidade_atual<=1 ) {
						alert('ATENÇÃO: O cliente precisa ser identificado para vendas em carteira!');
					} else {
