...
if($_GET['user'] != '' && $_GET['password'] != '' ){
		...
		$sql = query("SELECT * FROM user WHERE user_tx_status != 'inativo' AND user_tx_login = '$_GET[user]' AND user_tx_senha = '".md5($_GET[password])."'");
		...
		if(mysqli_num_rows($sql)>0){
			...
			header("Location: https://braso.mobi/techps/index2.php?erro=1");
			exit;
	...
	header("Location: https://braso.mobi/techps/index2.php");
	exit;
}
		...
		<div class="content">
			...
			<form class="login-form" method="post">
				...
				<div class="form-group">
					...
					<input focus autofocus class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Usuário" name="login" /> </div>
