...
function index(){
	...
	$cab = array('CÓDIGO','CLIENTE','TELEFONE','CELULAR','PRODUTO','DATA ALERTA','SITUAÇÃO','','');
	$val = array('aler_nb_id','enti_tx_nome','enti_tx_fone1','enti_tx_cel','prod_tx_nome','data(aler_tx_data)','ucfirst(aler_tx_status)','icone_finaliza(aler_nb_id,finaliza_alerta)',
