...
function index(){
	...
	<div class="container-fluid">
		...
		<div class="col-sm-3 sidenav">
			...
			<div class="botoes">
				...
				<button type="button" class="btn btn-default col-md-5" data-toggle="modal" data-target="#modalVendas"><img src="img/icon006.png" alt="img/icon006.png"/> Vendas (F6)</button>
	...
	<script type="text/javascript">
		...
		function testa_atalhos_pdv(keyCode,e){
			switch (keyCode) {
				case 113:
					// ABRE O MODAL DE PAGAMENTOS (F2)
					e.preventDefault();//DESATIVA A FUNCIONALIDADE DA TECLA PRESCIONADA
					$("#modalPagamento").modal("show");
				break;

				case 115:
					// ABRE O MODAL DE OPERAÇÕES (F4)
					e.preventDefault();//DESATIVA A FUNCIONALIDADE DA TECLA PRESCIONADA
					$("#modalOperacoes").modal("show");
				break;

				case 116:
					// ABRE O MODAL DE CLIENTES (F5)
					e.preventDefault();//DESATIVA A FUNCIONALIDADE DA TECLA PRESCIONADA
					$("#modalCliente").modal("show");
				break;

				case 117:
					// ABRE O MODAL DE VENDAS (F6)
					e.preventDefault();//DESATIVA A FUNCIONALIDADE DA TECLA PRESCIONADA
					$("#modalVendas").modal("show");
				break;

				case 118:
					// IMPRIME A VENDA ATUAL (F7)
					e.preventDefault();//DESATIVA A FUNCIONALIDADE DA TECLA PRESCIONADA
					imprimir_venda();
				break;

				case 119:
					// ABRE O MODAL DE FECHAMENTO DE CAIXA (F8)
					e.preventDefault();//DESATIVA A FUNCIONALIDADE DA TECLA PRESCIONADA
