...
function fechamento_caixa(){
	...
	foreach ($_POST[valor_fechamento] as $id_forma => $valor) {
		...
		$extra = " AND fobo_nb_forma='$id_forma' AND orde_nb_caixa='$_SESSION[id_caixa]' AND fobo_tx_status!='inativo' AND orde_tx_status!='inativo' AND orde_tx_situacao='finalizado' ";
