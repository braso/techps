...
function layout_procuracao(){
	...
	cabeca_planilha();
		...
		<section style="font-size: 10pt;">
			<p style="position: relative;margin: 0;padding: 5%;width: 90%;float: left;line-height: 30px;text-align: justify;text-indent: 5%;">Eu, <b><?=$a[enti_tx_nome]?></b>, RG: <b><?=$a[enti_tx_rg]?></b>, CPF: <b><?=$a[enti_tx_cpf]?></b>, nacionalidade: brasileira, estado civil: <b><?=$a[enti_tx_civil]?></b>, residente e domiciliado em <b><?=$a[enti_tx_endereco]?>, <?=$a[enti_tx_numero]?>, <?=$a[enti_tx_bairro]?>, <?=$a[enti_tx_complemento]?>, <?=$a[cida_tx_nome]?></b>, nomeio Wilza da Silva Queiroz, Corretora de Imóveis, CRECI 5283F, RG: 4328301 SSP-PA, CPF: 621.358.213-49, com escritório na Av. João da Escóssia, 25 - Bairro: Doze Anos, com o fim específico de me representar junto às instituições bancárias (CAIXA ECONÔMICA FEDERAL e BANCO DO BRASIL) referente ao financiamento na compra de um imóvel.</p>
